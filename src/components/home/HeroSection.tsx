...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col px-6 py-28 sm:px-10 lg:py-36">
        <div className="flex items-center gap-4">
          <span className="h-px w-12 bg-belarus-red/70" />
          ...
          <span className="hidden h-px flex-1 max-w-[8rem] bg-stone/20 sm:block" />
        </div>
        ...
        <div className="mt-12 max-w-2xl border-l-2 border-belarus-red/40 pl-8">
          <p className="manuscript text-lg leading-[1.9] text-pearl md:text-xl">
            A luxury software atelier — Belarusian discipline, biblical conviction,
            and enterprise rigor in one portfolio operating system.
          </p>
      ...
      <a
        href="#platform"
        className="absolute bottom-10 right-8 z-20 hidden flex-col items-center gap-2 text-[0.65rem] uppercase tracking-[0.35em] text-mist transition-colors hover:text-champagne md:flex"
      >
        Scroll
